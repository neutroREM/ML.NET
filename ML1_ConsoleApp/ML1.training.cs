...
namespace ML1_ConsoleApp
{
    public partial class ML1
    {
        public const string RetrainFilePath =  @"C:\Users\dhama\source\repos\XMLDatabase\XMLDatabase\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LightGbm(new LightGbmMulticlassTrainer.Options(){NumberOfLeaves=529,NumberOfIterations=1893,MinimumExampleCountPerLeaf=20,LearningRate=0.22127199244998008,LabelColumnName=@"col1",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.9999997766729865,FeatureFraction=0.8913037465672662,L1Regularization=2.582913303211854E-10,L2Regularization=0.2798783175667946},MaximumBinCountPerFeature=264}))      
